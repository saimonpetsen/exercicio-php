    ...
    <div class="col-lg-6">
        <form action="usuario_gravar.php" method="POST">
            <div class="form-group">
                ...
                <input type="text" name="nome" class="form-control" id="nome" placeholder="Insira seu nome" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="telefone" name="telefone" placeholder="Insira seu Telefone" required>
            </div>
